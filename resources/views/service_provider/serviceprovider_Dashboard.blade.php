      ...
      >
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
          <div class="modal-content mx-auto p-3">
            ...
            <div class="modal-body">
              <form action="{{ route('provider.update',$service_provider->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                <!-- Full Name -->
                <div class="mb-3">
      ...
      >
        <div class="modal-dialog modal-dialog-centered">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form id="modalForm" method="POST" action="{{ route('provider.update.password',$service_provider->id) }}">
                @csrf
      ...
      >
        <div class="modal-dialog modal-dialog-centered">
          <div class="modal-content">
            ...
            <div class="modal-body">
        <form id="emailUpdateForm" method="POST" action="{{ route('provider.update.email',$service_provider->id) }}">
                @csrf
                <div class="form-group">
                  <label for="modalInput">Enter new value:</label>
                  <input
      ...
      >
        <div class="modal-dialog modal-dialog-centered">
          <div class="modal-content">
            ...
            <form id="phoneUpdateForm" method="POST" action="{{ route('provider.update.phone',$service_provider->id) }}">
            @csrf
                <div class="form-group">

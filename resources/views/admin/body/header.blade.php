    ...
    <nav class="navbar navbar-expand">
        ...
        <ul class="navbar-nav align-items-center">
          ...
          <li class="nav-item dropdown dropdown-large">
            <a class="nav-link dropdown-toggle dropdown-toggle-nocaret position-relative" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
              <span class="alert-count">{{ $user ? $user->unreadNotifications()->count() : 0 }}</span>
            ...
            <div class="dropdown-menu dropdown-menu-end">
              <a href="javascript:;">
                <div class="msg-header d-flex justify-content-between align-items-center">
                  ...
                  <form method="POST" action="{{ route('admin.notifications.readAll') }}">
                    @csrf
                    <button type="submit" class="btn btn-link msg-header-clear p-0">Mark all as read</button>
                  </form>
                </div>
              </a>
              ...
              <div class="header-notifications-list">
                @php
                  $latestNotifs = $user ? $user->notifications()->latest()->take(7)->get() : collect();
                @endphp

                @forelse($latestNotifs as $notification)
                  <a class="dropdown-item" href="javascript:;">
                    <div class="d-flex align-items-center">
                      <div class="notify bg-light-primary text-primary"><i class="bx bx-bell"></i></div>
                      <div class="flex-grow-1">
                        ...
                        <p class="msg-info">{{ data_get($notification->data,'message','') }}</p>
                      </div>
                    </div>
                  </a>
                @empty
                  <div class="text-center p-2">No notifications</div>
                @endforelse
              </div>

              <a href="javascript:;"><div class="text-center msg-footer">View All Notifications</div></a>
            </div>
          </li>
          <!-- ✅ نهاية الإشعارات -->
          ...
          <li class="nav-item dropdown dropdown-large">
            ...
            <div class="dropdown-menu dropdown-menu-end">
              ...
              <a href="javascript:;"><div class="text-center msg-footer">View All Messages</div></a>
            </div>
          </li>
        </ul>
      </div>
      ...
      <div class="user-box dropdown">
        <a class="d-flex align-items-center nav-link dropdown-toggle dropdown-toggle-nocaret" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
          <img src="{{ asset(Auth::user()->photo ?? 'upload/admin_images/no_image.jpg') }} " class="user-img" alt="user avatar">
